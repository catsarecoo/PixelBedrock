...
bot = commands.Bot(command_prefix="bt!", owner_id=546812331213062144, case_insensitive=False)
line_divide = "\n———————————————————————————————"
...
class PixelBedrockTesting(commands.Bot):
    def __init__(self):
        super().__init__(command_prefix="bt!", owner_id=546812331213062144, reconnect=True, case_insensitive=False)
...
PixelBedrockTesting().run(pixelbedrock_testing_token)